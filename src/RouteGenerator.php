...
class RouteGenerator
{
    ...
    const WARNING_TEXT = "{{-- THIS IS GENERATED ROUTE FILE DO NOT EDIT THIS FILE. IF YOU WANT TO EDIT PLEASE HANDLE IT IN THE _sidebar.blade.php FILE.  --}}\n";
    ...
    {
        $this->MODULE_PATH = config("modules.paths.modules");
    ...
    // TODO check this include keywords performance
